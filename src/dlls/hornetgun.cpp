...
void CHgun::PrimaryAttack()
{
	...
	PLAYBACK_EVENT_FULL( flags, m_pPlayer->edict(), m_usHornetFire, 0.0f, (float *)&g_vecZero, (float *)&g_vecZero, 0.0f, 0.0f, FIREMODE_TRACK, 0, 0, 0 );
...
void CHgun::SecondaryAttack( void )
{
	...
	PLAYBACK_EVENT_FULL( flags, m_pPlayer->edict(), m_usHornetFire, 0.0f, (float *)&g_vecZero, (float *)&g_vecZero, 0.0f, 0.0f, FIREMODE_FAST, 0, 0, 0 );
...
void CHgun::WeaponIdle( void )
{
	...
	{
		iAnim = HGUN_IDLE1;
		m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + 30.0f / 16.f * 2.f;
	}
