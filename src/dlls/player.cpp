...
int CBasePlayer::Save( CSave &save )
{
	...
	return save.WriteFields( "PLAYER", this, m_playerSaveData, VARRAYSIZE(m_playerSaveData) );
}
...
int CBasePlayer::Restore( CRestore &restore )
{
	...
	int status = restore.ReadFields( "PLAYER", this, m_playerSaveData, VARRAYSIZE(m_playerSaveData) );
