...
Drawing functions:
	...
	int  SPR_Width( VHSPRITE x, int f )
		Returns the width, in pixels, of a sprite at the specified frame.  
		Returns 0 is the frame number or the sprite handle is invalid.

	int  SPR_Set( VHSPRITE sprite, int r, int g, int b );
