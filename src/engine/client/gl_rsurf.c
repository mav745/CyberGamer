...
//	{
//		if( hasScale )
//			glTexCoord2f(( v[3] + sOffset ) * xScale, ( v[4] + tOffset ) * yScale );
//		else glTexCoord2f( v[3] + sOffset, v[4] + tOffset );
...
//	glTexEnvi( GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE );
//	glColor4f( 1.0f, 1.0f, 1.0f, cl.refdef.movevars->wateralpha );
...
//		need_sort = true;
//	case kRenderGlow:
//		glColor4ub( 255, 255, 255, e->curstate.renderamt );
//		break;
//	case kRenderTransColor:
//		glDisable( GL_TEXTURE_2D );
//		glColor4ub( e->curstate.rendercolor.r, e->curstate.rendercolor.g,
