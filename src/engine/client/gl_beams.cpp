...
{
	cl_viewbeams = reinterpret_cast<BEAM*>(Mem_Alloc( cls.mempool, sizeof( BEAM ) * GI->max_beams ));
	cl_beamtrails = reinterpret_cast<particle_t*>(Mem_Alloc( cls.mempool, sizeof( particle_t ) * GI->max_beams * BEAM_TRAILS ));
	CL_ClearViewBeams();
}
