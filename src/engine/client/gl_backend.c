...
////	}
////	else if( glSelectTextureSGIS )
////	{
////		glSelectTextureSGIS( tmu + GL_TEXTURE0_SGIS );
////	}
//}
...
////	}
////	else if( glMTexCoord2fSGIS )
////	{
////		glMTexCoord2fSGIS( texture + GL_TEXTURE0_SGIS, s, t );
////	}
//}
...
//			glDisable( glState.currentTextureTargets[glState.activeTMU] );
//		glState.currentTextureTargets[glState.activeTMU] = target;
//		if( target != GL_NONE )
//			glEnable( glState.currentTextureTargets[glState.activeTMU] );
//	}
//}
...
//	// get screen frame
//	glReadPixels( 0, 0, r_shot->width, r_shot->height, GL_RGB, GL_UNSIGNED_BYTE, r_shot->buffer );
