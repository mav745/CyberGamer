...
void VGUI_UploadTexture( int id, const char *buffer, int width, int height )
{
	...
	g_textures[id] = GL_LoadTextureInternal( texName, &r_image, static_cast<texFlags_t>(TF_IMAGE), false );
...
void VGUI_CreateTexture( int id, int width, int height )
{
	...
	g_textures[id] = GL_LoadTextureInternal( texName, &r_image, static_cast<texFlags_t>(TF_IMAGE|TF_NEAREST), false );
	GL_SetTextureType( g_textures[id], TEX_VGUI );
	g_iBoundTexture = id;
}
