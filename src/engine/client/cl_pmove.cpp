...
void CL_InitClientMove( void )
{
	...
	// common utilities
	clgame.pmove->PM_Info_ValueForKey = reinterpret_cast<const char	*(*) ( const char *s, const char *key )>(Info_ValueForKey);
	...
	clgame.pmove->PM_HullForBsp = reinterpret_cast<void*(*)( physent_t *pe, float *offset )>(pfnHullForBsp);
	clgame.pmove->PM_TraceModel = pfnTraceModel;
	clgame.pmove->COM_FileSize = reinterpret_cast<int(*)( char *filename )>(COM_FileSize);
	clgame.pmove->COM_LoadFile = reinterpret_cast<byte*(*)( char *path, int usehunk, int *pLength )>(COM_LoadFile);
