...
void SV_UpdateServerInfo( void )
{
	...
	Cvar_LookupVars( CVAR_SERVERINFO, NULL, NULL, reinterpret_cast<setpair_t>(pfnUpdateServerInfo) );
...
void SV_ReadPackets( void )
{
	...
	while( NET_GetPacket( NS_SERVER, &net_from, net_message_buffer, reinterpret_cast<size_t*>(&curSize) ))
	{
