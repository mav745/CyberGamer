...
void Con_SetColor_f( void )
{
	...
	case 2:
		...
		Con_DefaultColor( (int)color[0], (int)color[1], (int)color[2] );
		break;
	case 4:
...
//{
//	return Q_stricmp( reinterpret_cast<const char*>(arg1), reinterpret_cast<const char*>(arg2) );
//}
...
void Con_CompleteCommand( field_t *field )
{
	...
	Cmd_LookupCmds( NULL, NULL, reinterpret_cast<setpair_t>(Con_AddCommandToList) );
	Cvar_LookupVars( 0, NULL, NULL, reinterpret_cast<setpair_t>(Con_AddCommandToList) );
	...
	else
	{
		...
		qsort( con.cmds, con.matchCount, sizeof( char* ), reinterpret_cast<int (*)(const void*,const void*)>(Con_SortCmds) );
		...
		Cmd_LookupCmds( NULL, NULL, reinterpret_cast<setpair_t>(Con_PrintMatches) );
		Cvar_LookupVars( 0, NULL, NULL, reinterpret_cast<setpair_t>(Con_PrintMatches) );
	}
}
